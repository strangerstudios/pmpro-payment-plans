	...
	<div class="acc-body">		
		<table class='form-table'>
			...
			<tr>
				...
				<td>
					<select id='pmpropp_plan_default' name='pmpropp_plan_default[]' selectval='!!default!!'>
			...
			<tr>
				...
				<td>
					<input type="hidden" name="pmpropp_recurring[]" value="0"><input id="pmpropp_recurring_!!plan_id!!" name="pmpropp_recurring_checkbox[]" class="pmpropp_recurring" type="checkbox" value="yes"/>
			...
			<tr>
				...
				<td><input type="hidden" name="pmpropp_plan_expiration[]" value="0"><input id="pmpropp_plan_expiration_!!plan_id!!" class="pmpropp_plan_expiration" name="pmpropp_plan_expiration_checkbox[]" type="checkbox" value="yes"> <label for="pmpropp_plan_expiration_!!plan_id!!"><?php esc_html_e( 'Check this to set when membership access expires.', 'pmpro-payment-plans' ); ?></label></td>
			</tr>
